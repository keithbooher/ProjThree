        ...
        return (
            <div>
                ...
                <div className="container content">
                    <h2 className="margin">Before you can get started, please sign up with stripe</h2>
                    <button className="margin"><a href="https://connect.stripe.com/oauth/authorize?response_type=code&client_id=ca_DW5XNKTvUAeODU0hK38cYryqiz6QGJFF&scope=read_write">Connect with Stripe</a></button>
                    ...
                    <button className="margin" onClick={() => this.handleFormSubmit()}>Become an Admin</button>
                </div>
            </div>
        );
    };
